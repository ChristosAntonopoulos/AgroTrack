...
export function generateDemoDataset(referenceDate = new Date()): DemoDataset {
  ...
  const issues: DemoIssue[] = [
    ...
    {
      id: '675555555555555555555303',
      fieldId: DEMO_FIELD_IDS[2],
      type: 'Equipment',
      severity: 'Low',
      title: 'Harvest net tear — repair scheduled',
      description: 'Giorgos ordered replacement; Kostas patched temporarily.',
      photoUrls: [DEMO_IMAGES[2]],
...
export function getPinnedDemoTasks(now = new Date()): DemoTask[] {
  ...
  return [
    ...
    {
      id: '675555555555555555556f04',
      fieldId: DEMO_FIELD_IDS[4],
      type: 'Irrigation',
