    ...
    recent: [
      {
        ...
        message: "Task 'Pruning — north block' status changed to completed",
        actorUserId: 'user-1',
        taskId: 'task-1',
      ...
      },
      {
        ...
        fieldId: 'field-1',
        type: 'evidence_added',
        message: "Evidence added to task 'Pruning — north block'",
        actorUserId: 'user-1',
        taskId: 'task-1',
      ...
      },
      {
        ...
        fieldId: 'field-2',
        type: 'expense_logged',
        message: 'Logged expense €45 for fertilizer',
        actorUserId: 'user-1',
