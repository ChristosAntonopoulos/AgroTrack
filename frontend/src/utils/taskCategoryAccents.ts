import type { TaskTemplateCategory } from '../types/oliveTaskTemplate';
import { CATEGORY_STYLES } from './taskTemplateUtils';
...
export const resolveTaskCategoryAccent = (type?: string | null): string => {
  ...
  const styled = CATEGORY_STYLES[type as TaskTemplateCategory];
