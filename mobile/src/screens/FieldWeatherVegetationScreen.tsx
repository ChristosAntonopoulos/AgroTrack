...
const FieldWeatherVegetationScreen = () => {
  ...
  if (!field) {
    return (
      <ScreenLayout scroll contentContainerStyle={styles.content}>
        <EmptyState title={t('chronologio:weatherVegetation.failedLoad')} />
      </ScreenLayout>
    );
  }
    ...
    <ScreenLayout scroll contentContainerStyle={styles.content}>
      <View style={styles.intro}>
        ...
        <Text style={[styles.title, { color: colors.textPrimary }]}>
          {t('chronologio:weatherVegetation.title', { name: field.name })}
        </Text>
        <Text style={[styles.desc, { color: colors.textSecondary }]}>{t('chronologio:weatherVegetation.description')}</Text>
      </View>
      ...
      <View style={styles.ranges} accessibilityRole="tablist" accessibilityLabel={t('chronologio:weatherVegetation.rangeAria')}>
        {ranges.map((item) => {
      ...
      <Text style={[styles.source, { color: colors.textTertiary }]}>{t('chronologio:weatherVegetation.sourceNote')}</Text>
    </ScreenLayout>
  );
};
