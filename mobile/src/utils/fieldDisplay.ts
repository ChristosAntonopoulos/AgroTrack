...
export const getLifecycleStageLabel = (stage: string | undefined, t: TFunction): string | null => {
...
export const getFieldStatusLabel = (status: string | undefined, t: TFunction): string => {
  ...
  return t(`fields:fieldStatus.${key}`, {
    defaultValue: t(`fields:addField.statuses.${key}`, { defaultValue: '' }),
  });
};
...
export const chronologioDetailLine = (entry: ChronologioEntry, locale: string): string => {
