...
| Offline-first συγχρονισμός (τοπική DB, CRDT, conflict UI) | Προσθέτει πολυπλοκότητα· οι πιλότοι έχουν συνδεσιμότητα | Μετά το MVP αν το ζητήσουν οι πιλότοι |
...
> **Σημείωση:** Το mobile app έχει lighter **pragmatic outbox** (AsyncStorage cache τελευταίων fields/tasks + ουρά mutations + sync στο reconnect). Αυτό δεν είναι full offline-first DB sync και παραμένει εκτός του «βαρέως» στοιχείου παραπάνω.
