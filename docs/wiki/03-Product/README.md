...
Τι είναι το Oleachron ως προϊόν, τι περιλαμβάνει το MVP, τι όχι, και για ποιον απευθύνεται. Η πιο σημαντική σελίδα εδώ είναι η [Ορισμός MVP](./MVP-Definition.md) — ελέγχει το εύρος.
...
- [Βασικά features](./Core-Features.md) — τι κάνει το Oleachron, με απλά λόγια
