...
Η database είναι εκεί που το Oleachron αποθηκεύει όλες τις πληροφορίες πελατών — πεδία, κύκλους καλλιέργειας, εργασίες, δραστηριότητες, έξοδα, χρήστες κ.λπ. Κάθε φορά που ο χρήστης κάνει κάτι στην εφαρμογή (δημιουργεί πεδίο, καταγράφει δραστηριότητα, προσθέτει έξοδο), τα δεδομένα πηγαίνουν εδώ.
