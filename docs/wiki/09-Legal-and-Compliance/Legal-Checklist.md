...
| L7 | Terms of Service για το Oleachron | Απαιτείται πριν τον πρώτο πληρωτή πελάτη | Δεν ξεκίνησε |
| L8 | Privacy Policy για το Oleachron | Απαιτείται πριν από οποιαδήποτε εγγραφή χρήστη | Δεν ξεκίνησε |
...
| L11 | Αναζήτηση και κατάθεση σήματος | Προστασία ονόματος «Oleachron» | Δεν ξεκίνησε |
