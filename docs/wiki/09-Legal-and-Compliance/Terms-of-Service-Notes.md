...
Εργαζόμενα σημειώματα για τους Terms of Service του Oleachron. Οι τελικοί όροι πρέπει να ελεγχθούν από δικηγόρο.
...
- Δεν ευθυνόμαστε για αγροτικά αποτελέσματα — το Oleachron καταγράφει και βοηθά, αλλά δεν παίρνει αγρονομικές αποφάσεις για τον χρήστη.
