...
Πώς το Oleachron χειρίζεται προσωπικά δεδομένα σύμφωνα με το GDPR της ΕΕ. Δεν αποτελεί νομική συμβουλή — εργαζόμενη περίληψη για την ομάδα.

## Ποιοι εμπίπτουν

Λειτουργούμε στην ΕΕ και αποθηκεύουμε δεδομένα για κατοίκους ΕΕ. Το GDPR ισχύει για το Oleachron.
...
2. **Περιορισμός σκοπού** — χρησιμοποιούμε δεδομένα μόνο για το προϊόν του Oleachron.
