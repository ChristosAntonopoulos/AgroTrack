...
A running list of all completed customer interviews. Each interview is a child page (or section) using the [Customer Interview Template](../11%20Templates/Customer%20Interview%20Template.md).
...
1. Copy the [Customer Interview Template](../11%20Templates/Customer%20Interview%20Template.md) content.
2. Add a row in the table above.
3. Paste the filled template as a section below, or create a child page.
4. Update [Pain Points](./Pain%20Points.md) with anything new.
