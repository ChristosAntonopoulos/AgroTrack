...
Η πλήρης επιχειρηματική εικόνα: ποιος έχει το πρόβλημα, ποιος πληρώνει, ποιος άλλος το λύνει, πώς βγάζουμε χρήμα και πώς θα ξέρουμε ότι έχουμε δίκιο.

Αυτή είναι η βαθύτερη ενότητα του wiki — διαβάστε πρώτα το [Business Plan](./Business-Plan.md) ως χάρτη για τα υπόλοιπα.
...
- [Financial Plan](./Financial-Plan.md) — κόστη, υπόθεση εσόδων, runway
- [Risks and Assumptions](./Risks-and-Assumptions.md) — σε τι στοιχηματίζουμε
- [Validation Plan](./Validation-Plan.md) — πώς αποδεικνύουμε ή ανατρέπουμε την επιχείρηση
