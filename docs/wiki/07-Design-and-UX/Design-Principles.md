...
Σύντομη λίστα κανόνων που καθοδηγούν κάθε απόφαση σχεδιασμού στο Oleachron.
...
9. **Δύο τρόποι εμφάνισης, ένα προϊόν.** Καθημερινή (Everyday) και Πλήρης εικόνα (Full picture) — ίδια δεδομένα, διαφορετική πυκνότητα. Βλ. [Experience Modes](./Experience-Modes.md).
10. **Άνεση ≠ εμπειρία.** Το μέγεθος κειμένου και τα μεγάλα κουμπιά είναι ανεξάρτητα από τη λειτουργία εμφάνισης.
...
- Ξεχωριστές εφαρμογές για «απλούς» και «προχωρημένους» χρήστες.
- Ονόματα τύπου Beginner / Simple / Pro που υποτιμούν τον χρήστη.
...
- Χρειαζόμαστε dark mode για ορατότητα έξω; → Υπάρχει· συνδυάζεται με Large text / Large controls.
...
- Δοκιμή Everyday / Full picture με πραγματικούς owners και producers (βλ. [Experience Modes](./Experience-Modes.md))
