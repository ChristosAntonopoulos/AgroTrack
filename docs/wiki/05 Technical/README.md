...
- [Technical Overview](./Technical%20Overview.md) — the system in one page
...
- [Data Model](./Data%20Model.md) — the entities we track, in plain language
- [API Design](./API%20Design.md) — how the parts talk to each other
- [Authentication and Authorization](./Authentication%20and%20Authorization.md) — who can do what
- [Infrastructure](./Infrastructure.md) — where it all runs
- [DevOps and CICD](./DevOps%20and%20CICD.md) — how code reaches customers
- [Security](./Security.md) — how we protect customer data
- [Technical Decision Log](./Technical%20Decision%20Log.md) — record of technical choices
