AgroTrack Agronomic Task Intelligence Specification
===================================================

Document Purpose
----------------

This document describes how AgroTrack should connect field tasks with weather, soil, satellite, crop-stage, pesticide, and official-warning data.
...
The thresholds in this document are provisional AgroTrack defaults. They must not override:
...
3. Data Available to AgroTrack
==============================

3.1 Weather Data
----------------

AgroTrack may collect or calculate:
*   Air temperature.
...
AgroTrack must not present estimated rainfall as a confirmed field measurement.
Correct wording:
...
Product-label values must override AgroTrack defaults.

5.2 Data Evaluated Before Spraying
----------------------------------

AgroTrack should evaluate:
*   Current wind speed.
...
| Condition | Provisional AgroTrack Result |
| --- | --- |
...
AgroTrack should automatically create:
...
AgroTrack must never automatically create a repeat pesticide application.
...
> The planned irrigation is equivalent to approximately 12 mm. AgroTrack estimates a current climatic deficit of 7 mm and approximately 9 mm of effective rainfall tomorrow. Cancelling or reducing irrigation is recommended.
...
AgroTrack should not convert weather suitability directly into a disease diagnosis.
Correct:
...
AgroTrack may compare later satellite observations.
Permitted wording:
...
AgroTrack should not automatically create a spraying task from every official warning.
...
9.  AgroTrack crop-specific default.
    
10.  AgroTrack generic default.
...
Every AgroTrack warning should include:
*   Field name.
...
21. Recommended Initial AgroTrack Scope
=======================================
...
AgroTrack should not simply collect weather and satellite data.
...
> AgroTrack monitors every field task before, during, and after execution and warns the user when weather, field conditions, crop stage, or treatment restrictions may affect the result.