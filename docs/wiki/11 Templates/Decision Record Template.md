...
Copy this template into [Decision Log](../01%20Company/Decision%20Log.md) or [Technical Decision Log](../05%20Technical/Technical%20Decision%20Log.md) for every important decision.
