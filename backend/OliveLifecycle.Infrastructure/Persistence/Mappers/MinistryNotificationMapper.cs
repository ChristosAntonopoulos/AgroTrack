...
public static class HarvestRecordMapper
{
    public static HarvestRecord ToEntity(HarvestRecordDocument document) => new()
    {
        ...
        ResultYear = document.ResultYear != 0
            ? document.ResultYear
            : OliveLifecycle.Core.Time.AthensTime.CalendarYear(document.HarvestDate),
        ...
        OilLitres = document.OilLitres,
        ConversionFactor = document.ConversionFactor,
        ConversionSource = document.ConversionSource,
        ConversionRecordedAt = document.ConversionRecordedAt,
    ...
    public static HarvestRecordDocument ToDocument(HarvestRecord entity) => new()
    {
        ...
        ResultYear = entity.ResultYear != 0
            ? entity.ResultYear
            : OliveLifecycle.Core.Time.AthensTime.CalendarYear(entity.HarvestDate),
        HarvestMethod = entity.HarvestMethod,
        WorkersUsed = entity.WorkersUsed,
        OliveKg = entity.OliveKg,
        MillName = entity.MillName,
        OilKg = entity.OilKg,
        OilLitres = entity.OilLitres,
        ConversionFactor = entity.ConversionFactor,
        ConversionSource = entity.ConversionSource,
        ConversionRecordedAt = entity.ConversionRecordedAt,
